...
public class Serverr {
    ...
    public Serverr(int port, RequestProcessing requestProcessing) {
                ...
                for (SelectionKey key : keys) {
                    if (key.isAcceptable()) {
                        ...
                        if (key.isReadable()) {
                            ...
                            currentResponse = requestProcessing.processing(r);
    ...
    private boolean processRequest() {
        ...
        try {
            ...
            do {
                ...
                System.out.println("запрос "+request.getCommandName()+" получен");
                // request = getRequest();
                if (request == null) continue;
                response = requestProcessing.processing(request);
                System.out.println("отправляется ответ "+response.getResponseBody());
